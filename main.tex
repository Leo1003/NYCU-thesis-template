...
% 論文名稱
\newcommand{\chineseTitle}{建置基於單一事實來源之自動化憑證管理系統}
\newcommand{\englishTitle}{Building Automatic Certificate Management System Based on Single Source of Trust}

% 自己的名字 (英文名字有兩種寫法, 一個是姓在後, 一個是放前面還有逗號. )
\newcommand{\studentCnName}{陳少甫}
\newcommand{\studentEnName}{Shao-Fu Chen} % 書名頁
\newcommand{\studentEnNameA}{Chen, Shao-Fu} % 封面用
...
\newcommand{\ThesisDateTW}{中華民國~ 一一四年五月}
